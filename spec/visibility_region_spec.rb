...
describe VisibilityRegion, "which generated by VisibilityMap" do
  ...
  describe "#intersect" do
    specify { subject.intersect(@normalized_listener_position).should be_collection(IntersectionPoints).of(IntersectionPoint) }
    specify { subject.intersect(@normalized_listener_position).length.should == 2 }
  end
end
